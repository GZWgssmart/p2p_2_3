                                ...
                                <div class="all-view">
                                    <div class="center-view">
                                        <div class="center-header">
                                            <img src="<%=path%>/static/images/account/header.png" width="120"
                                                 height="120">
                                        </div>
                                    ...
                                    <div class="center-main">
                                        ...
                                        <div class="center-data">
                                            <p><i class="color color1"></i>投资总额：<span id="investSum">{{usermoney.tzmoney}}</span>
                                            </p>
                                            ...
                                            <p><i class="color color4"></i>奖励金额：<span id="otherEarnAmount">{{usermoney.jlmoney}}</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="chongz " id="chongz">
                            ...
                            <div class="account-content">
                                ...
                                <div class="ipay-pay">
                                    ...
                                    <div class="pay-from">
                                        <div class="label cl">
                                            <label>充值金额：</label><input type="text" id="ipay-amt" maxlength="18"
                                                                       placeholder="请输入充值金额">
                                            <p class="roll">元</p>
                                        </div>
                                        <div class="label cl">
                                ...
                                <div class="layui-form">
                                    <div class="ipay-list" style="display: block;">
                                        <div class="layui-form-item">
                                            ...
                                            <button class="layui-btn layui-btn-primary" @click="serarchRechargeRecord">
                            ...
                            <div class="account-content" style="display: block;">
                                ...
                                <div class="cash-pay">
                                    <p class="tips-title">
                                        ...
                                        1）请输入您要提现的金额，我们将在1至3个工作日(国家节假日除外)之内将钱转入您网站上填写的银行账号。<br>
                                        2）每笔提现金额至少为100元以上。
                                    </p>
                                    <div class="pay-from">
                                        <div class="label cl">
                                            <label class="long">持卡人：</label>
                                            <p class="text" id="cash-realName">${sessionScope.User.rname}</p>
                                        </div>
                                        <div class="label cl">
                                            <label class="long">可提现金额：</label>
                                            <p class="text color" id="cash-usableSum">{{usermoney.kymoney}}</p>
                                        </div>
                                        <div class="label cl label-msg">
                                            ...
                                            <ul class="select-box">
                                                ...
                                                <li data-name="建设银行" data-bankno="6212842120000014699"><a
                                                        href="javascript:;">建设银行&nbsp;&nbsp;|&nbsp;&nbsp;6212 ********
                                                    4699</a></li>
                                            </ul>
                                        </div>
                                        <div class="label cl">
                                            <label class="long">提现金额：</label><input type="text" maxlength="15"
                                                                                    id="cashInput"
                                                                                    placeholder="请输入提现金额">
                                        </div>

                                        <div class="label cl">
                                            <label class="long">手机号码：</label>
                                            <p class="text " id="withdrawPhone">${sessionScope.User.phone}</p>
                                        </div>
                                        <div class="label cl label-msg">
                                            <label class="long">验证码：</label><input type="text" maxlength="6"
                                                                                   id="cash-smsCode"
                                ...
                                <div class="cash-list" style="display: block;">
                                    <div class="layui-form-item">
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" class="layui-input" v-model="dateQuery.startTime"
                                                       id="date3" placeholder="yyyy-MM-dd">
                                            </div>
                                        </div>
                                        <div class="layui-inline">
                                            <label class="layui-form-label">结束日期</label>
                                            <div class="layui-input-inline">
                                                <input type="text" class="layui-input" v-model="dateQuery.endTime"
                                                       id="date4" placeholder="yyyy-MM-dd">
                                            </div>
                                        </div>
                                        <button class="layui-btn layui-btn-primary" @click="serarchWithdrawRecord"><i
                                                class="layui-icon">&#xe615;</i>搜索
                                        </button>
                                    </div>
                                    <div class="account-list">
                                        <li v-for="txRecordVO in rows">
                                            <ul class="cash-list-box list-box">
                                                ...
                                                <li class="title" v-for="txRecordVO in rows">
                                                    <div class="children0">${session.user.rname}</div>
                                                    <div class="children1">{{txRecordVO.money}}</div>
                                                    <div class="children2">{{txRecordVO.cardno}}</div>
                                                    <div class="children4">{{txRecordVO.createdTime}}</div>
                                                    <div class="children5">{{txRecordVO.status}}</div>
                                                </li>
                                            </ul>
                                        </li>
                                        <div id="recharge"></div>
                    ...
                    <div class="account-content">
                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                <label class="layui-form-label">开始日期</label>
                                <div class="layui-input-inline">
                                    <input type="text" class="layui-input" v-model="dateQuery.startTime" id="date5"
                            ...
                            <div class="layui-inline">
                                <label class="layui-form-label">结束日期</label>
                                <div class="layui-input-inline">
                                    <input type="text" class="layui-input" v-model="dateQuery.endTime" id="date6"
                                           placeholder="yyyy-MM-dd">
                                </div>
                            </div>
                            <button class="layui-btn layui-btn-primary" @click="serarchMoneyRecord"><i
                                    class="layui-icon">&#xe615;</i>搜索
                            </button>
                        </div>
                        <div class="account-list">
                            <ul class="fund-list-box list-box">
                                <li class="title">
                                    ...
                                    <div class="children0">时间</div>
                                </li>
                                <li v-for="logmoneyVO in rows" class="title">
                                    <div class="children0">{{logmoneyVO.type}}</div>
                                    <div class="children1">{{logmoneyVO.income}}</div>
                                    <div class="children2">{{logmoneyVO.outlay}}</div>
                                    <div class="children3">{{logmoneyVO.date}}</div>
                                </li>
                            </ul>
                    ...
                    <div class="bo1">
                            ...
                            <div class="account-content" id="" style="display: block;">
                                ...
                                <div class="account-form cl">
                                    <input type="text" class="date icon icon-date" autocomplete="off"
                                           id="invest-startDate" readonly="readonly">
                                    <p class="text">至</p>
                                    <input type="text" class="date icon icon-date" autocomplete="off"
                                           id="invest-endDate" readonly="readonly">
                        ...
                        <div class="skmx " id="skmx">
                            ...
                            <div class="account-content" id="payment" style="display: block;">
                                ...
                                <div class="account-form cl">
                                    <input type="text" class="date icon icon-date" autocomplete="off"
                                           id="payment-startDate" readonly="readonly">
                                    <p class="text">至</p>
                                    <input type="text" class="date icon icon-date" autocomplete="off"
                                           id="payment-endDate" readonly="readonly">
                        ...
                        <div class="cygm " id="cygm">
                            ...
                            <div class="account-content">
                                ...
                                <div id="played-claimbuy">
                                    <div class="account-form cl">
                                        <input type="text" class="date icon icon-date" id="played-claimbuy-startDate"
                                               readonly="readonly">
                                        <p class="text">至</p>
                                        <input type="text" class="date icon icon-date" id="played-claimbuy-endDate"
                                               readonly="readonly">
                                ...
                                <ul class="safe-list">
                                    ...
                                    <li>
                                        ...
                                        <div class="safe-list-3">
                                            ...
                                            <div class="site-demo-button" id="layerDemo" style="margin-bottom: 0;">
                                                <button data-method="upEmail" data-type="c"
                                    ...
                                    <li>
                                        ...
                                        <div class="safe-list-3">
                                            ...
                                            <div class="site-demo-button" id="layerDemo" style="margin-bottom: 0;">
                                                <button data-method="updatePwd" data-type="c"
                                                        class="layui-btn layui-btn-normal">修改
                                                </button>
                                            </div>
                                        </div>
                            ...
                            <div class="account-content">
                                <div class="tuijian-list" style="display: block;">
                                    ...
                                    <div class="account-list">
                                        ...
                                        <ul class="tuijian-list listData" style="display: block;">
                                            <li class="none" style="line-height: 60px;">没有符合条件的内容！</li>
                                        </ul>
                                        <ul class="paging"></ul>
                                    </div>
