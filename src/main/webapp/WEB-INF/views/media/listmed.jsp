...
<script>
    ...
    list = new Vue({
        ...
        methods: {
            ...
            save: function () {
                window.location.href = " /back/med/save";
            ...
            tofindone: function (id) {
                ...
                params.append('id', id);
                window.location.href = "/back/med/byiddync?id=" + id
            ...
            toupd: function (id) {
                ...
                var params = new URLSearchParams();
                params.append('id', id);
                window.location.href = "/back/med/updmed?id=" + id
            ...
            remove: function (id) {
                ...
                axios.post('/media/data/json/removemedia', params).then((response) => {
                    this.listmed();
                }, (error) => {
                    alert(error);
                });
            ...
            if(layEvent === 'updmed'){
                ...
                layer.msg('是否删除当前首页图片10s后自动取消', {
                    ...
                    yes:function(){
                        ...
                        console.log(data.mid)
                        obj.del(data.mid); //删除对应行（tr）的DOM结构
                        layer.close(index);
                    },
                    btn2: function () {
                        layer.msg('已取消');
