...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <div class="about-content">
        ...
        <div id="chengtou" class="content">
            ...
            <ul class="img-list">
                <li>
                    <img src="resources/front/v01/src/images/about/chengtou01.png">
                    <p>人民医院新院</p>
                </li>
                <li>
                    <img src="resources/front/v01/src/images/about/chengtou02.png">
                    <p>红旗大道东延返迁房</p>
                </li>
                <li class="nomargin">
                    <img src="resources/front/v01/src/images/about/chengtou03.png">
                    <p>沙石大桥</p>
                </li>
                <li>
                    <img src="resources/front/v01/src/images/about/chengtou04.png">
                    <p>锦江山庄</p>
                </li>
                <li>
                    <img src="resources/front/v01/src/images/about/chengtou05.png">
                    <p>自然博物馆</p>
                </li>
                <li class="nomargin">
                    <img src="resources/front/v01/src/images/about/chengtou06.png">
                    <p>赣州高等师范专科学校</p>
                </li>
            </ul>
        </div>
        <div id="shzc" class="content" style="display: none;">
            ...
            <ul class="img-list">
                <li>
                    <img src="resources/front/v01/src/images/about/shenghui01.jpg" width="285" height="200">
                </li>
                <li>
                    <img src="resources/front/v01/src/images/about/shenghui02.jpg" width="285" height="200">
                </li>
                <li class="nomargin">
                    <img src="resources/front/v01/src/images/about/shenghui03.jpg" width="285" height="200">
                </li>
                <li>
                    <img src="resources/front/v01/src/images/about/shenghui04.jpg" width="285" height="200">
                </li>
                <li>
                    <img src="resources/front/v01/src/images/about/shenghui05.jpg" width="285" height="200">
                </li>
                <li class="nomargin">
                    <img src="resources/front/v01/src/images/about/shenghui06.jpg" width="285" height="200">
                </li>
            </ul>
        </div>
    </div>