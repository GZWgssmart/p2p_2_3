    ...
    <div class="tableDiv">
        <table class="table2" style="width:900px;">
            ...
            <tr>
                ...
                <td class="tdRight">
                    指同一自然人在该平台的借款余额是否超过人民币20万元；同一法人或其他组织在该平台的借款余额是否超过人民币100万元；同一自然人在不同网络借贷信息中介机构平台借款总余额是否超过人民币100万元；同一法人或其他组织在不同网络借贷信息中介机构平台借款总余额是否超过人民币500万元。
                </td>
            </tr>
            </tbody>
        </table>
...
<div class="about-content" id="xmjsDiv" style="display: none;">
    <div class="tableDiv">
        <div class="textItem">
            ...
            <p class="text" style="text-indent: 0;"><span class="textRight colorText">恒大商票以保理公司持有的大型知名企业签发并承兑的商业承兑汇票为还款保障的金融产品，借款到期时，保理公司以承兑企业无条件支付的票面</span>
            </p>
            <p class="text" style="text-indent: 0;"><span class="textRight colorText">资金用于归还借款本息。</span></p>
            <img class="xmjsImg" src="resources/front/v01/src/images/hengjin.png" alt="恒金保" width="900">
        </div>
        <div class="fgx"></div>
        <div class="textItem">
            <p class="text marginBottom" style="text-indent: 0;"><span class="textRight titleText">普金保</span></p>
            <p class="text" style="text-indent: 0;"><span class="textRight colorText">基于供应链上下游的采购贸易，为采购方或项目方提供融资，融资方以应收账款质押、保证金担保等形式为借款提供担保。</span>
            </p>
            <img class="xmjsImg" src="resources/front/v01/src/images/pujin.png" alt="普金保" width="900">
        </div>
        <div class="fgx"></div>
        <div class="textItem">
            <p class="text marginBottom" style="text-indent: 0;"><span class="textRight titleText">多金宝</span></p>
            <p class="text" style="text-indent: 0;"><span class="textRight colorText">企业由于生产经营周转或项目投资需要资金，提供足值的不动产或动产作为抵质押物申请借款。</span>
            </p>
            <center><img class="xmjsImg" src="resources/front/v01/src/images/duojin.png" alt="多金保" width="550"></center>
        </div>
    </div>
</div>
